...
// - createCircle(xPos,yPos,radius,color) - creates a circle object and 
// - render(object) - renders an object on the canvas.
// - renderMulti(array) - renders an array of objects.
// - renderDisplayList() - renders the display list array to the canvas.
...
function render(object){
	...
	switch(object.objectType){
		...
		case "circle":
			...
			break;
		case "text":
			canvasCtx.font = object.font;
			canvasCtx.fillText(object.objectText, object.xPosition, object.yPosition);
			break;
		default:
			console.log("Not a valid object type for render() " + object);
	}
}
function renderMulti(array){
...
function removeChild(object){
	displayList.splice(object);
}
function renderDisplayList(){
	renderMulti(displayList);
}
...
/*Object Creation*/
function createCircle(xPos,yPos,rad,color){
	var newCircle = {
		objectType: "circle",
		objectColor: color,
		xPosition: xPos,
